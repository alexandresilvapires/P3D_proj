...
float Texture2DSample_A8(Texture2D Tex, SamplerState Sampler, float2 UV)
{
	...
	return Tex.SampleLevel(Sampler, UV, ComputeRayConeLod(Tex) + GlobalTextureMipBias) .r;
...
{
#line  49 "/Engine/Private/EyeAdaptationCommon.ush"
...
#line 288 "/Engine/Private/BasePassCommon.ush"
