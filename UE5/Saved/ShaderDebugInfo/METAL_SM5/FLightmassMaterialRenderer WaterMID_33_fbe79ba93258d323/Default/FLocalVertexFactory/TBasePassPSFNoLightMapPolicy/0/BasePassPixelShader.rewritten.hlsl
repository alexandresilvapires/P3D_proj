...
// #define MESHSHADER 0
// #define METAL_INDIRECT_ARGUMENT_BUFFERS 
// #define METAL_USE_FAST_INTRINSICS 0
...
// #define PIXELSHADEROUTPUT_MRT4 1
...
// #define REFRACTION_USE_PIXEL_NORMAL_OFFSET 1
// #define SCENE_TEXTURES_DISABLED 0
// #define SELECTIVE_BASEPASS_OUTPUTS 0
// #define SHADER_LANGUAGE_VERSION 7
...
#line  10 "/Engine/Public/Platform/Metal/MetalCommon.ush"
...
#line  53 "/Engine/Public/Platform/Metal/MetalCommon.ush"
...
#line  74 "/Engine/Public/Platform/Metal/MetalCommon.ush"
...
#line  28 "/Engine/Public/Platform.ush"
...
#line 299 "/Engine/Public/Platform.ush"
...
#line   2 "/Engine/Generated/UniformBuffers/FogStruct.ush"
...
#line   2 "/Engine/Generated/UniformBuffers/LumenGIVolumeStruct.ush"
...
#line   2 "/Engine/Generated/UniformBuffers/TranslucentSelfShadow.ush"
...
cbuffer   TranslucentSelfShadow 
{
	 ...
	 uint BindlessResource_TranslucentSelfShadow_Transmission0 ;
	 uint  PrePadding_TranslucentSelfShadow_116;
	 uint BindlessResource_TranslucentSelfShadow_Transmission1 ;
	 uint  PrePadding_TranslucentSelfShadow_124;
	 uint BindlessSampler_TranslucentSelfShadow_Transmission0Sampler ;
	 uint  PrePadding_TranslucentSelfShadow_132;
...
#line   2 "/Engine/Generated/UniformBuffers/Nanite.ush"

cbuffer   Nanite 
{
	 int4  Nanite_PageConstants;
	 int4  Nanite_MaterialConfig;
	 uint  Nanite_MaxNodes;
	 uint  Nanite_MaxVisibleClusters;
	 uint  Nanite_RenderFlags;
	 float  Nanite_RayTracingCutError;
	 float4  Nanite_RectScaleOffset;
	 uint BindlessResource_Nanite_ClusterPageData ;
	 uint  PrePadding_Nanite_68;
	 uint BindlessResource_Nanite_VisibleClustersSWHW ;
	 uint  PrePadding_Nanite_76;
	 uint BindlessResource_Nanite_HierarchyBuffer ;
	 uint  PrePadding_Nanite_84;
	 uint BindlessResource_Nanite_MaterialTileRemap ;
	 uint  PrePadding_Nanite_92;
	 uint BindlessResource_Nanite_MaterialDepthTable ;
	 uint  PrePadding_Nanite_100;
	 uint BindlessResource_Nanite_MaterialResolve ;
	 uint  PrePadding_Nanite_108;
	 uint BindlessResource_Nanite_VisBuffer64 ;
	 uint  PrePadding_Nanite_116;
	 uint BindlessResource_Nanite_DbgBuffer64 ;
	 uint  PrePadding_Nanite_124;
	 uint BindlessResource_Nanite_DbgBuffer32 ;
	 uint  PrePadding_Nanite_132;
	 uint BindlessResource_Nanite_ShadingRate ;
	 uint  PrePadding_Nanite_140;
	 uint BindlessResource_Nanite_RayTracingDataBuffer ;
	 uint  PrePadding_Nanite_148;
	 uint  Nanite_MultiViewEnabled;
	 uint  PrePadding_Nanite_156;
	 uint BindlessResource_Nanite_MultiViewIndices ;
	 uint  PrePadding_Nanite_164;
	 uint BindlessResource_Nanite_MultiViewRectScaleOffsets ;
	 uint  PrePadding_Nanite_172;
	 uint BindlessResource_Nanite_InViews ;
}
  ByteAddressBuffer  Nanite_ClusterPageData ;
  ByteAddressBuffer  Nanite_VisibleClustersSWHW ;
  ByteAddressBuffer  Nanite_HierarchyBuffer ;
  StructuredBuffer<uint>  Nanite_MaterialTileRemap ;
  ByteAddressBuffer  Nanite_MaterialDepthTable ;
  Texture2D<uint2>  Nanite_MaterialResolve ;
  Texture2D<uint2>  Nanite_VisBuffer64 ;
  Texture2D<uint2>  Nanite_DbgBuffer64 ;
  Texture2D<uint>  Nanite_DbgBuffer32 ;
  Texture2D<uint>  Nanite_ShadingRate ;
  StructuredBuffer<uint>  Nanite_RayTracingDataBuffer ;
  StructuredBuffer<uint>  Nanite_MultiViewIndices ;
  StructuredBuffer<float4>  Nanite_MultiViewRectScaleOffsets ;
  StructuredBuffer<FPackedNaniteView>  Nanite_InViews ;
/*atic const struct
{
	 int4  PageConstants;
	 int4  MaterialConfig;
	...
	Texture2D<uint2> VisBuffer64;
	Texture2D<uint2> DbgBuffer64;
	Texture2D<uint> DbgBuffer32;
	Texture2D<uint> ShadingRate;
	StructuredBuffer<uint> RayTracingDataBuffer;
	StructuredBuffer<uint> MultiViewIndices;
	StructuredBuffer<float4> MultiViewRectScaleOffsets;
	StructuredBuffer<FPackedNaniteView> InViews;
} Nanite = {Nanite_PageConstants,Nanite_MaterialConfig,Nanite_MaxNodes,Nanite_MaxVisibleClusters,Nanite_RenderFlags,Nanite_RayTracingCutError,Nanite_RectScaleOffset,Nanite_MultiViewEnabled,Nanite_ClusterPageData,Nanite_VisibleClustersSWHW,Nanite_HierarchyBuffer,Nanite_MaterialTileRemap,Nanite_MaterialDepthTable,Nanite_MaterialResolve,Nanite_VisBuffer64,Nanite_DbgBuffer64,Nanite_DbgBuffer32,Nanite_ShadingRate,Nanite_RayTracingDataBuffer,Nanite_MultiViewIndices,Nanite_MultiViewRectScaleOffsets,Nanite_InViews,*/
...
#line   2 "/Engine/Generated/UniformBuffers/MaterialCollection0.ush"
...
#line  46 "/Engine/Generated/GeneratedUniformBuffers.ush"

#line   2 "/Engine/Generated/UniformBuffers/Material.ush"

cbuffer   Material 
{
	 float4  Material_PreshaderBuffer[23];
...
} Material = {Material_PreshaderBuffer,Material_Texture2D_0,Material_Texture2D_0Sampler,Material_Texture2D_1,Material_Texture2D_1Sampler,Material_Texture2D_2,Material_Texture2D_2Sampler,Material_Wrap_WorldGroupSettings,Material_Clamp_WorldGroupSettings,*/

#line  47 "/Engine/Generated/GeneratedUniformBuffers.ush"
...
#line  25 "/Engine/Private/BasePassPixelShader.usf"
...
float CalcSceneCustomDepth(float2 ScreenUV)
{
	...
	return ConvertFromDeviceZ(Texture2DSampleLevel(SceneTexturesStruct_CustomDepthTexture, SceneTexturesStruct_PointClampSampler, ScreenUV, 0).r);
...
uint CalcSceneCustomStencil(uint2 PixelPos)
{
	...
	return SceneTexturesStruct_CustomStencilTexture.Load(uint3(PixelPos, 0)) .x;
...
float CalcSceneAO(float2 ScreenUV)
{
	...
	return Texture2DSampleLevel(SceneTexturesStruct_ScreenSpaceAOTexture, SceneTexturesStruct_PointClampSampler, ScreenUV, 0).r;
...
float EyeAdaptationLookup()
{
		...
		return EyeAdaptationLookupBuffer(OpaqueBasePass_EyeAdaptationBuffer).x;
...
FPrimitiveSceneData GetPrimitiveData(uint PrimitiveId)
{
	...
	PrimitiveData.InstancePayloadDataStride				= asuint(LoadPrimitivePrimitiveSceneDataElement(PrimitiveIndex, 27).w);
	...
	PrimitiveData.MaxWPODisplacement					= LoadPrimitivePrimitiveSceneDataElement(PrimitiveIndex, 31).x;
	PrimitiveData.CustomStencilValueAndMask				= asuint(LoadPrimitivePrimitiveSceneDataElement(PrimitiveIndex, 31).y);
...
#line 1244 "/Engine/Private/SceneData.ush"
...
#line   3 "/ShaderAutogen/METAL_SM5/AutogenShaderHeaders.ush"
...
FGBufferData DecodeGBufferDataUV(float2 UV, bool bGetNormalizedNormal = true)
{
	...
	uint CustomStencil = SceneTexturesStruct_CustomStencilTexture.Load(int3(IntUV, 0)) .x;
...
FGBufferData DecodeGBufferDataUint(uint2 PixelPos, bool bGetNormalizedNormal = true)
{
	...
	uint CustomStencil = SceneTexturesStruct_CustomStencilTexture.Load(int3(PixelPos, 0)) .x;
	...
	float4 InMRT4 = SceneTexturesStruct_GBufferVelocityTexture.Load(int3(PixelPos, 0)).xyzw;
	float4 InMRT5 = SceneTexturesStruct_GBufferDTexture.Load(int3(PixelPos, 0)).xyzw;
	float4 InMRT6 = SceneTexturesStruct_GBufferETexture.Load(int3(PixelPos, 0)).xyzw;
...
#line 510 "/ShaderAutogen/METAL_SM5/AutogenShaderHeaders.ush"
...
#line 186 "/Engine/Private/MaterialTexture.ush"
...
FDBufferData GetDBufferData(float2 BufferUV, uint RTMaskBit)
{
	...
	if (RTMaskBit & 0x2)
	{
		DBufferB = Texture2DSampleLevel(OpaqueBasePass_DBufferBTexture, OpaqueBasePass_DBufferBTextureSampler, BufferUV, 0);
	}

	[branch]
	if (RTMaskBit & 0x4)
	{
		DBufferC = Texture2DSampleLevel(OpaqueBasePass_DBufferCTexture, OpaqueBasePass_DBufferCTextureSampler, BufferUV, 0);
	}
...
FLWCVector2Deriv ConstructConstantFLWCVector2Deriv(FLWCVector2 Value)
{
...
FloatDeriv2 AddDeriv(FloatDeriv2 A, FloatDeriv2 B)
{
	FloatDeriv2 Ret;
...
FloatDeriv2 SubDeriv(FloatDeriv2 A, FloatDeriv2 B)
{
	FloatDeriv2 Ret;
	Ret.Value = A.Value - B.Value;
	Ret.Ddx = A.Ddx - B.Ddx;
...
FloatDeriv2 DivDeriv(FloatDeriv2 A, FloatDeriv2 B)
{
	FloatDeriv2 Ret;
	Ret.Value = A.Value / B.Value;
	float2 Denom = rcp(B.Value * B.Value);
	float2 dFdA =  B.Value * Denom;
	float2 dFdB = -A.Value * Denom;
	Ret.Ddx = dFdA * A.Ddx + dFdB * B.Ddx;
	Ret.Ddy = dFdA * A.Ddy + dFdB * B.Ddy;
	return Ret;
}

FloatDeriv3 DivDeriv(FloatDeriv3 A, FloatDeriv3 B)
{
	FloatDeriv3 Ret;
	Ret.Value = A.Value / B.Value;
	float3 Denom = rcp(B.Value * B.Value);
	float3 dFdA =  B.Value * Denom;
	float3 dFdB = -A.Value * Denom;
	Ret.Ddx = dFdA * A.Ddx + dFdB * B.Ddx;
	Ret.Ddy = dFdA * A.Ddy + dFdB * B.Ddy;
	return Ret;
}
...
FloatDeriv SaturateDeriv(FloatDeriv A)
{
	...
	bool InRange =  and_internal( 0.0 < A.Value , A.Value < 1.0 );
	Ret.Ddx =  select_internal( InRange , A.Ddx , Zero );
	Ret.Ddy =  select_internal( InRange , A.Ddy , Zero );
	return Ret;
}

FloatDeriv2 SaturateDerivLWC(FLWCVector2Deriv A)
{
	float2 Zero = 0.0f;
	FloatDeriv2 Ret;
	Ret.Value = LWCSaturate(A.Value);
	bool2 InRange = LWCEquals(Ret.Value, A.Value);
	Ret.Ddx =  select_internal( InRange , A.Ddx , Zero );
	Ret.Ddy =  select_internal( InRange , A.Ddy , Zero );
	return Ret;
}

FloatDeriv2 FracDeriv(FloatDeriv2 A)
{
	FloatDeriv2 Ret;
	Ret.Value = frac(A.Value);
	Ret.Ddx = A.Ddx;
	Ret.Ddy = A.Ddy;
	return Ret;
}

FloatDeriv LerpDeriv(FloatDeriv A, FloatDeriv B, FloatDeriv S)
{
	FloatDeriv Ret;
...
float CustomExpression0(FMaterialPixelParameters Parameters)
{
return GetWaterWaveParamIndex(Parameters);
}


#line   7 "/Plugin/Water/Private/GerstnerWaveFunctions.ush"
...
{
	const int AbsoluteWaveDataIndex = InWaterBodyHeader.DataIndex + (InWaveIndex * 2);

	float4 Data0 = View_WaterData[AbsoluteWaveDataIndex];
	float4 Data1 = View_WaterData[AbsoluteWaveDataIndex + 1];
...
{
	const FWaterBodyHeader WaterBodyHeader = DecodeWaterBodyHeader(View_WaterIndirection[InWaterBodyIndex]);
...
#line 2848 "/Engine/Generated/Material.ush"

float3 CustomExpression1(FMaterialPixelParameters Parameters,float WaterBodyIndex,float2 WorldPosition,float Time)
{
WaveOutput Waves;
...
float3 CustomExpression2(FMaterialPixelParameters Parameters,float3 inPackedWave)
{
		float3 outWPO;
...
float CustomExpression3(FMaterialPixelParameters Parameters,float WaterBodyIndex,float WaterDepth)
{
return ComputeWaveDepthAttenuationFactorNew(WaterBodyIndex, WaterDepth);
}


float3 CustomExpression4(FMaterialPixelParameters Parameters,float3 Color,float x)
{
...
{
return float3(1.00000, 1.00000, 1.00000);
}
...
#line 3153 "/Engine/Generated/Material.ush"
...
#line 3345 "/Engine/Generated/Material.ush"
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	float4 Local0 = MaterialCollection0_Vectors[3];
	float3 Local1 = (Material_PreshaderBuffer[1].xyz / ((float3)Local0.b));
	float2 Local2 = (LWCToFloat(MakeLWCVector2(Material_PreshaderBuffer[13].xy,Material_PreshaderBuffer[13].zw)) * Material_PreshaderBuffer[9].yz);
	float2 Local3 = (Local2 - ((float2)0.50000000));
	float2 Local4 = floor(Local3);
	float2 Local5 = (Local4 + ((float2)0.50000000));
	float2 Local6 = (Local5 * Material_PreshaderBuffer[14].xy);
	float Local7 =  1.0f;
	float4 Local8 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleLevel(Material_Texture2D_0,GetMaterialSharedSampler(Material_Texture2D_0Sampler,View_MaterialTextureBilinearClampedSampler),Local6,0.00000000));
	float Local9 =  1.0f;
	float2 Local10 = (Local6 + Material_PreshaderBuffer[15].yz);
	float Local11 =  1.0f;
	float4 Local12 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleLevel(Material_Texture2D_0,GetMaterialSharedSampler(Material_Texture2D_0Sampler,View_MaterialTextureBilinearClampedSampler),Local10,0.00000000));
	float Local13 =  1.0f;
	float2 Local14 = frac(Local3);
	float Local15 =   Local14 .r;
	float4 Local16 = lerp(Local8.rgba,Local12.rgba,  Local15 );
	float2 Local17 = (Local6 + Material_PreshaderBuffer[16].xy);
	float Local18 =  1.0f;
	float4 Local19 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleLevel(Material_Texture2D_0,GetMaterialSharedSampler(Material_Texture2D_0Sampler,View_MaterialTextureBilinearClampedSampler),Local17,0.00000000));
	float Local20 =  1.0f;
	float2 Local21 = (Local6 + Material_PreshaderBuffer[14].zw);
	float Local22 =  1.0f;
	float4 Local23 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleLevel(Material_Texture2D_0,GetMaterialSharedSampler(Material_Texture2D_0Sampler,View_MaterialTextureBilinearClampedSampler),Local21,0.00000000));
	float Local24 =  1.0f;
	float4 Local25 = lerp(Local19.rgba,Local23.rgba,  Local15 );
	float Local26 =   Local14 .g;
	float4 Local27 = lerp(Local16,Local25,  Local26 );
	float Local28 = (Local27.b * Material_PreshaderBuffer[17].x);
	float Local29 = (Local28 + Material_PreshaderBuffer[16].w);
	float Local30 = (Local27.a * Material_PreshaderBuffer[17].z);
	float Local31 = (Local30 + Material_PreshaderBuffer[17].y);
	float Local32 = (Local31 - Material_PreshaderBuffer[17].w);
	float Local33 =  select_internal( (abs(Local27.b - 0.00000000) > 0.00001000) ,  select_internal( (Local27.b >= 0.00000000) , Local29 , Local32 ) , Local32 );
	float Local34 = (Local33 - Local31);
	float Local35 = saturate(Local34);
	float3 Local36 = lerp(((float3)1.00000000),Material_PreshaderBuffer[19].xyz,0.50000000);
	float Local37 = CustomExpression0(Parameters);
	float4 Local38 = MaterialCollection0_Vectors[1];
	float4 Local39 = MaterialCollection0_Vectors[2];
	float Local40 = lerp(Local38.r,Local0.r,Local39.a);
	float3 Local41 = CustomExpression1(Parameters,Local37,float3(0.00000000,0.00000000,0.00000000).xy,Local40);
	float3 Local42 = CustomExpression2(Parameters,Local41);
	FLWCVector2 Local43 = LWCSubtract(LWCPromote(float3(0.00000000,0.00000000,0.00000000).xy), MakeLWCVector2(Material_PreshaderBuffer[5].yz,float2(Material_PreshaderBuffer[5].w, Material_PreshaderBuffer[6].x)));
	FLWCVector2 Local44 = LWCMultiply(Local43, MakeLWCVector2(float2(Material_PreshaderBuffer[19].w, Material_PreshaderBuffer[20].x),Material_PreshaderBuffer[20].yz));
	FLWCVector2 Local45 = LWCMultiply(Local44, LWCPromote(Material_PreshaderBuffer[11].zw));
	float2 Local46 = LWCSaturate(Local45);
	float2 Local47 = (  Local46  * Material_PreshaderBuffer[9].yz);
	float2 Local48 = (  Local47  - ((float2)0.50000000));
	float2 Local49 = floor(  Local48 );
	float2 Local50 = (Local49 + ((float2)0.50000000));
	float2 Local51 = (Local50 * Material_PreshaderBuffer[14].xy);
	float Local52 =  1.0f;
	float4 Local53 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleLevel(Material_Texture2D_0,GetMaterialSharedSampler(Material_Texture2D_0Sampler,View_MaterialTextureBilinearClampedSampler),Local51,0.00000000));
	float Local54 =  1.0f;
	float2 Local55 = (Local51 + Material_PreshaderBuffer[15].yz);
	float Local56 =  1.0f;
	float4 Local57 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleLevel(Material_Texture2D_0,GetMaterialSharedSampler(Material_Texture2D_0Sampler,View_MaterialTextureBilinearClampedSampler),Local55,0.00000000));
	float Local58 =  1.0f;
	float2 Local59 = frac(  Local48 );
	float Local60 =   Local59 .r;
	float4 Local61 = lerp(Local53.rgba,Local57.rgba,  Local60 );
	float2 Local62 = (Local51 + Material_PreshaderBuffer[16].xy);
	float Local63 =  1.0f;
	float4 Local64 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleLevel(Material_Texture2D_0,GetMaterialSharedSampler(Material_Texture2D_0Sampler,View_MaterialTextureBilinearClampedSampler),Local62,0.00000000));
	float Local65 =  1.0f;
	float2 Local66 = (Local51 + Material_PreshaderBuffer[14].zw);
	float Local67 =  1.0f;
	float4 Local68 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleLevel(Material_Texture2D_0,GetMaterialSharedSampler(Material_Texture2D_0Sampler,View_MaterialTextureBilinearClampedSampler),Local66,0.00000000));
	float Local69 =  1.0f;
	float4 Local70 = lerp(Local64.rgba,Local68.rgba,  Local60 );
	float Local71 =   Local59 .g;
	float4 Local72 = lerp(Local61,Local70,  Local71 );
	float Local73 = (Local72.b * Material_PreshaderBuffer[17].x);
	float Local74 = (Local73 + Material_PreshaderBuffer[16].w);
	float Local75 = (Local72.a * Material_PreshaderBuffer[17].z);
	float Local76 = (Local75 + Material_PreshaderBuffer[17].y);
	float Local77 = (Local76 - Material_PreshaderBuffer[17].w);
	float Local78 =  select_internal( (abs(Local72.b - 0.00000000) > 0.00001000) ,  select_internal( (Local72.b >= 0.00000000) , Local74 , Local77 ) , Local77 );
	float Local79 = (Local78 - Local76);
	float Local80 = max(Local79,0.00000000);
	float Local81 = CustomExpression3(Parameters,Local37,Local80);
	float3 Local82 = (Local42 * ((float3)Local81));
	float Local83 = (Local40 * Material_PreshaderBuffer[20].w);
	float Local84 = (Local83 * 0.10000000);
	float Local85 = GetPixelDepth(Parameters);
	float Local86 =   Local85 .r;
	float Local87 = (  Local86  - Material_PreshaderBuffer[21].x);
	float Local88 = (  Local87  * Material_PreshaderBuffer[21].z);
	float Local89 = saturate(  Local88 );
	float Local90 = ceil(  Local89 );
	float Local91 = saturate(Local90);
	float Local92 = lerp(Material_PreshaderBuffer[21].w,Material_PreshaderBuffer[22].x,  Local91 );
	float3 Local93 = (float3(0.00000000,0.00000000,0.00000000) / ((float3)  Local92 ));
	float2 Local94 =   Local93 .rg;
	float2 Local95 = (float2(Local84,Local84) +   Local94 );
	float Local96 =  1.0f;
	float4 Local97 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material_Texture2D_1,GetMaterialSharedSampler(Material_Texture2D_1Sampler,View_MaterialTextureBilinearWrapedSampler),  Local95 ));
	float Local98 =  1.0f;
	float Local99 = (Local83 * -0.10000000);
	float2 Local100 = (  Local94  + float2(0.41810000,0.35479999));
	float2 Local101 = (  Local100  / ((float2)1.61800003));
	float2 Local102 = (float2(Local99,Local99) +   Local101 );
	float Local103 =  1.0f;
	float4 Local104 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material_Texture2D_1,GetMaterialSharedSampler(Material_Texture2D_1Sampler,View_MaterialTextureBilinearWrapedSampler),  Local102 ));
	float Local105 =  1.0f;
	float3 Local106 = (Local97.rgb + Local104.rgb);
	float2 Local107 = (  Local94  + float2(0.86486101,0.14838400));
	float2 Local108 = (  Local107  / ((float2)1.23609400));
	float2 Local109 = (float2(Local99,Local84) +   Local108 );
	float Local110 =  1.0f;
	float4 Local111 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material_Texture2D_1,GetMaterialSharedSampler(Material_Texture2D_1Sampler,View_MaterialTextureBilinearWrapedSampler),  Local109 ));
	float Local112 =  1.0f;
	float3 Local113 = (Local106 + Local111.rgb);
	float3 Local114 = (Local113 * ((float3)0.33333299));
	float Local115 = (Local114.b - 0.50000000);
	float Local116 = (Local115 *   Local89 );
	float Local117 = (Local116 * 0.00000000);
	float3 Local118 = (((float3)Local117) * float3(0.00000000,0.00000000,1.00000000));
	float3 Local119 = lerp(Local82,Local118,  Local89 );
	float3 Local120 = (Local36 * Local119);
	float3 Local121 = (Local120 + float3(0.00000000,0.00000000,0.00000000));
	float4 Local122 = MaterialCollection0_Vectors[50];
	float2 Local123 = (Local121.xy.rg - Local122.rgba.rg);
	float4 Local124 = MaterialCollection0_Vectors[0];
	float2 Local125 = (Local123 / ((float2)Local124.a));
	float2 Local126 = (Local125 + ((float2)0.50000000));
	float Local127 =  1.0f;
	float4 Local128 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material_Texture2D_2,GetMaterialSharedSampler(Material_Texture2D_2Sampler,View_MaterialTextureBilinearClampedSampler),Local126));
	float Local129 =  1.0f;
	float Local130 = (Local33 + Local128.b);
	float Local131 = (Local130 - Local31);
	float Local132 = max(Local131,0.00000000);
	float Local133 = saturate(Local132);
	float Local134 = max(Local35,Local133);
	float Local135 = lerp(-1.00000000,1.00000000,Local134);
	float3 Local136 = CustomExpression4(Parameters,Local1,Local135);
	float3 Local137 = saturate(Local136);
...
#line 3886 "/Engine/Generated/Material.ush"
...
#line 3949 "/Engine/Generated/Material.ush"
...
#line 4174 "/Engine/Generated/Material.ush"
...
{
#line 4250 "/Engine/Generated/Material.ush"
...
#line  95 "/Engine/Private/VertexFactoryCommon.ush"
...
#line 196 "/Engine/Private/VertexFactoryCommon.ush"
...
#line 100 "/Engine/Private/LocalVertexFactory.ush"


#line 131 "/Engine/Private/LocalVertexFactory.ush"
...
float3x3 CalcTangentToLocal(FVertexFactoryInput Input, inout float TangentSign)
{
...
#line 913 "/Engine/Private/LocalVertexFactory.ush"
...
#line 1053 "/Engine/Private/LocalVertexFactory.ush"
...
float4 GetPrimaryPrecomputedShadowMask(float LightmapVTPageTableResult, FVertexFactoryInterpolantsVSToPS Interpolants, FMaterialPixelParameters MaterialParameters)
{
...
#line   7 "/Engine/Private/VelocityCommon.ush"
...
#line  73 "/Engine/Private/BasePassPixelShader.usf"


#line   3 "/Engine/Private/ShadingModelsSampling.ush"
...
#line 171 "/Engine/Private/SubsurfaceProfileCommon.ush"
...
#line  92 "/Engine/Private/ShadingModels.ush"
...
#line 184 "/Engine/Private/ShadingModelsSampling.ush"
...
#line   3 "/Engine/Private/SSRT/SSRTRayCast.ush"
...
#line 408 "/Engine/Private/SSRT/SSRTRayCast.ush"
...
#line 536 "/Engine/Private/SSRT/SSRTRayCast.ush"
...
#line 591 "/Engine/Private/SSRT/SSRTRayCast.ush"
...
#line  84 "/Engine/Private/BasePassPixelShader.usf"
...
#line 115 "/Engine/Private/BasePassPixelShader.usf"
...
#line 162 "/Engine/Private/BasePassPixelShader.usf"
...
#line 164 "/Engine/Private/BasePassPixelShader.usf"
...
{
	const float TexDeviceZWithOffset = OpaqueBasePass_ResolvedSceneDepthTexture.Load(int3(SvPosition.xy, 0)).r;

	uint PSDeviceZWithOffsetUINT  = uint(PSDeviceZWithOffset * 16777215.0f + 0.5f);	
	uint TexDeviceZWithOffsetUINT = uint(TexDeviceZWithOffset * 16777215.0f + 0.5f);
	
	const bool DepthTest_Equal = OpaqueBasePass_Is24BitUnormDepthStencil ?
		(PSDeviceZWithOffsetUINT == TexDeviceZWithOffsetUINT || PSDeviceZWithOffsetUINT == (TexDeviceZWithOffsetUINT - 1)) :	
		(PSDeviceZWithOffset == TexDeviceZWithOffset); 																			
...
#line 235 "/Engine/Private/BasePassPixelShader.usf"
...
#line 649 "/Engine/Private/BasePassPixelShader.usf"
...
#line 698 "/Engine/Private/BasePassPixelShader.usf"
...
#line 917 "/Engine/Private/BasePassPixelShader.usf"


#line 948 "/Engine/Private/BasePassPixelShader.usf"


	float DBufferOpacity = 1.0f;
#line 980 "/Engine/Private/BasePassPixelShader.usf"
...
#line 1044 "/Engine/Private/BasePassPixelShader.usf"
...
#line 1285 "/Engine/Private/BasePassPixelShader.usf"
...
#line 1333 "/Engine/Private/BasePassPixelShader.usf"
...
#line 1474 "/Engine/Private/BasePassPixelShader.usf"


#line 1492 "/Engine/Private/BasePassPixelShader.usf"
...
#line 1803 "/Engine/Private/BasePassPixelShader.usf"


	
#line 1881 "/Engine/Private/BasePassPixelShader.usf"
...
#line 1900 "/Engine/Private/BasePassPixelShader.usf"
...
#line 1955 "/Engine/Private/BasePassPixelShader.usf"

		}
		
#line 1979 "/Engine/Private/BasePassPixelShader.usf"
...
#line 2086 "/Engine/Private/BasePassPixelShader.usf"
...
#line 2107 "/Engine/Private/BasePassPixelShader.usf"
...
#line 2144 "/Engine/Private/BasePassPixelShader.usf"
...
#line   9 "/Engine/Private/PixelShaderOutputCommon.ush"
#line   4 "/Engine/Private/ShaderOutputCommon.ush"
...
#line 191 "/Engine/Private/PixelShaderOutputCommon.ush"
...
#line 2199 "/Engine/Private/BasePassPixelShader.usf"
